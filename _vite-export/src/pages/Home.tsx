  ...
  return (
    <>
      <section className="relative h-screen w-full overflow-hidden">
        {SLIDES.map((s, i) => (
          <div key={i} className="absolute inset-0" style={{ animation: `slideshow 18s infinite ${i * 6}s`, opacity: 0 }}>
        ...
        <style>{`@keyframes slideshow { 0%, 28% { opacity: 1; } 33%, 95% { opacity: 0; } 100% { opacity: 1; } }`}</style>
